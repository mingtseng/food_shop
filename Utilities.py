...
def draw_menu(root, role_state):
    ...
    addmenu.add_command(label='Добавить тип товара')
...
def create_good_btn(root, frame, role_state):
    ...
    del_good = Button(frame, font=btn_f, text='Удалить товар', width=btn_w, height=btn_h, state=role_state)
...
def create_distr_btn(root, frame, role_state):
    ...
    del_distr = Button(frame, font=btn_f, text='Удалить поставщика', width=btn_w, height=btn_h, state=role_state)
